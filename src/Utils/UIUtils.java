...
public class UIUtils {
    ...
    public static final Color COLOR_OUTLINE = new Color(174, 162, 13);
    public static final Color COLOR_BACKGROUND = new Color(249, 249, 249);
    public static final Color COLOR_INTERACTIVE = new Color(8, 80, 149);
    public static final Color COLOR_INTERACTIVE_DARKER = new Color(8, 59, 102);
