 ...
 * @author victormanuel
 */
public class Ver_calificaciones4 extends javax.swing.JInternalFrame {
...
//        validar();
    ...
    private void initComponents() {
        ...
        Panel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 250, -1, -1));
        ...
        Panel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, -1, -1));
        ...
        Panel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 210, -1, -1));
...
//        validar();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
           ...
           //se busca la ruta en donde se encuentra el reporte para enviarle los datos
            ...
            String path = "src\\Reportes\\cal1_1_3.jasper";
            ...
            reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/cal1_1_3.jasper"));
            ...
            Logger.getLogger(Ver_calificaciones4.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
           ...
           //se busca la ruta en donde se encuentra el reporte para enviarle los datos
            JasperReport reporte = null;
            String path = "src\\Reportes\\Boletas\\boleta1_3.jasper";
            ...
            //reporte = (JasperReport) JRLoader.loadObjectFromFile(path);
            reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/Boletas/boleta1_3.jasper"));
            //el reporte recibe los parametros
            JasperPrint jprint = JasperFillManager.fillReport(reporte,parametro,conn);
...
public void MostrarTablaCal(String x) {
		     ...
		     //manda los valores a la clase para que haga las instruciones sql
                cali.consultaCalificacion4ConTableModel(modelo, x);
