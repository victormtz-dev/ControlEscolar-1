 ...
 * @author victormanuel
 */
public class Calif_1 extends javax.swing.JInternalFrame {
...
//        validar();
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        ...
        int id = 0, grado_ = 1, mes_, periodo_, inasistencia_;
        ...
        try {
            ...
            obser_ = txt_observaciones.getText();
            ...
            if(cal1<5 || cal1 >10){
              ...
              cali.registrarCalificacion1(1, id, curp_, grado_, cal1, cal2, cal3, cal4, cal5, cal6, mes_, periodo_);
              ...
              if(mes_ == 8){    
              ResultSet r2= st2.executeQuery("SELECT * FROM calificaciones1 where curp='"+curp_+"' and id_mes='7';"); 
            ...
            if(cal1<5 || cal1 >10){
              ...
              validarvacios();
               ...
               if(mes_ == 9){
              ResultSet r3= st2.executeQuery("SELECT * FROM calificaciones1 where curp='"+curp_+"' and id_mes='8';"); 
            ...
            if(cal1<5 || cal1 >10){
              ...
              ResultSet r4= st2.executeQuery("SELECT * FROM calificaciones1 where curp='"+curp_+"' and id_mes='9';"); 
            ...
            if(cal1<5 || cal1 >10){
              ...
              ResultSet r5= st2.executeQuery("SELECT * FROM calificaciones1 where curp='"+curp_+"' and id_mes='10';"); 
            ...
            if(cal1<5 || cal1 >10){
              ...
              ResultSet r6= st2.executeQuery("SELECT * FROM calificaciones1 where curp='"+curp_+"' and id_mes='1';"); 
            ...
            if(cal1<5 || cal1 >10){
              ...
              ResultSet r7= st2.executeQuery("SELECT * FROM calificaciones1 where curp='"+curp_+"' and id_mes='2';"); 
              ...
              ResultSet r8= st2.executeQuery("SELECT * FROM calificaciones1 where curp='"+curp_+"' and id_mes='3';"); 
            ...
            if(cal1<5 || cal1 >10){
              ...
              ResultSet r9= st2.executeQuery("SELECT * FROM calificaciones1 where curp='"+curp_+"' and id_mes='4';"); 
            ...
            if(cal1<5 || cal1 >10){
              ...
              ResultSet r10= st2.executeQuery("SELECT * FROM calificaciones1 where curp='"+curp_+"' and id_mes='5';"); 
