...
//        validar();
    ...
    public void validarvacios(){
            if(txt_cal1.getText().isEmpty() || txt_cal2.getText().isEmpty() || txt_cal3.getText().isEmpty() || txt_curp.getText().isEmpty() ||
                ...
                || txt_cal8.getText().isEmpty() || txt_cal9.getText().isEmpty() || txt_ina.getText().isEmpty()){
                btn_registrar.setEnabled(false);
        }else {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Conocimiento del medio:");
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        ...
        try {
            ...
            if(cal1<5 || cal1 >10){
              ...
              cali.registrarCalificacion1(1, id, curp_, grado_, cal1, cal2, cal3, cal4, cal5, cal6, cal7, cal8, cal9, mes_, periodo_);
