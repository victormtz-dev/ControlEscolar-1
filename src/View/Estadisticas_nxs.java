 ...
 * @author victormanuel
 */
public class Estadisticas_nxs extends javax.swing.JInternalFrame {
 ...
 public void validadcaracterescurp (java.awt.event.KeyEvent evento){
    ...
    private void initComponents() {
        ...
        btn_registrar.setText("Imprimir estadistica");
        ...
        Panel1.add(btn_registrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 150, 150, 38));
        ...
        Panel1.add(btn_salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 220, 150, 38));
...
try {
           ...
           //se busca la ruta en donde se encuentra el reporte para enviarle los datos
            ...
            String path = "src\\Estadisticas_nxs\\ninosporsalon.jasper";
           ...
           // reporte = (JasperReport) JRLoader.loadObjectFromFile(path);
            ...
            reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Estadisticas_nxs/ninosporsalon.jasper"));
            ...
            Logger.getLogger(Estadisticas_nxs.class.getName()).log(Level.SEVERE, null, ex);
        }       
