...
//        validar();
    ...
    private void initComponents() {
        ...
        table_cal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Trimestre", "Mes", "CURP", "E. socioemocional", "Lengua materna", "Matematicas", "C. naturales", "Artes", "F.C.E.", "Vida saludable", "Ingles"
            }
        ));
        ...
        Panel1.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 880, 128));

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 153, 153));
        jLabel2.setText("Calificaciones:");
        Panel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 210, -1, -1));
