 ...
 * @author victormanuel
 */
public class Ver_calificaciones extends javax.swing.JInternalFrame {
...
//        validar();
    ...
    private void initComponents() {
        ...
        table_ina = new javax.swing.JTable();
        ...
        Panel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 40, 20));
        ...
        Panel1.add(txt_curp, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 190, 20));
        ...
        Panel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 190, 10));
        ...
        Panel1.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 690, 170));

        table_ina.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Trimestre", "Mes", "Inasistencias"
            }
        ));
        jScrollPane1.setViewportView(table_ina);

        Panel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 240, 180, 170));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 153, 153));
        jLabel1.setText("Inasistencias:");
        Panel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 210, -1, -1));
...
//        validar();
    ...
    private javax.swing.JTable table_ina;
...
public void MostrarTablaCal(String x) {
		     ...
		     //manda los valores a la clase para que haga las instruciones sql
                cali.consultaCalificacion1ConTableModel(modelo, x);

	}


public void MostrarTablaIna(String x) {

        

                DefaultTableModel modelo2 = new DefaultTableModel();
                table_ina.setModel(modelo2);

                modelo2.addColumn("Trimestre");
                modelo2.addColumn("Mes");
                modelo2.addColumn("Inasistencias");
             
 
                 //Ordenar las columnas
                TableRowSorter<TableModel> ordena = new TableRowSorter<TableModel>(modelo2);
                table_ina.setRowSorter(ordena);

		     //manda los valores a la clase para que haga las instruciones sql
                cali.consultaInasistenciaConTableModel(modelo2, x);
