...
//        validar();
    ...
    private void initComponents() {
        ...
        Panel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 200, -1, -1));
...
//        validar();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
           ...
           //se busca la ruta en donde se encuentra el reporte para enviarle los datos
            ...
            String path = "src\\Reportes\\cal1_1_1.jasper";
            ...
            reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/cal1_1_1.jasper"));
            ...
            Logger.getLogger(Ver_calificaciones2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
           ...
           //se busca la ruta en donde se encuentra el reporte para enviarle los datos
            JasperReport reporte = null;
            String path = "src\\Reportes\\Boletas\\boleta1_1.jasper";
            ...
            //reporte = (JasperReport) JRLoader.loadObjectFromFile(path);
            reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/Boletas/boleta1_1.jasper"));
            //el reporte recibe los parametros
            JasperPrint jprint = JasperFillManager.fillReport(reporte,parametro,conn);
