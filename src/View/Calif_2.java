 ...
 * @author victormanuel
 */
public class Calif_2 extends javax.swing.JInternalFrame {
...
//        validar();
    ...
    private void initComponents() {
        ...
        Panel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 170, -1, -1));
        ...
        Panel1.add(txt_ina, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 190, 70, -1));

        jLabel17.setText("Observaciones:");
        Panel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(485, 280, 120, -1));

        txt_o.setColumns(20);
        txt_o.setRows(5);
        jScrollPane2.setViewportView(txt_o);

        Panel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 310, 270, -1));
        ...
        jLabel2.setText("Exploracion de la naturaleza y la sociedad");
        Panel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, -1, 20));

        jLabel5.setText("Formacion civica y etica:");
        Panel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, -1, 20));

        jLabel9.setText("Educacion artistica:");
        Panel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 284, -1, 30));

        jLabel10.setText("Educacion fisica:");
        Panel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 314, -1, 30));
...
//        validar();
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        ...
        int id = 0, grado_ = 2, mes_, periodo_, inasistencia_;
        ...
        try {
            ...
            //SI EL MES SELECCIONADO NO HA SIDO CAPTURADO
             ...
             if(mes_ == 7)
             {
              ...
              if(mes_ == 8){    
              ResultSet r2= st2.executeQuery("SELECT * FROM calificaciones2 where curp='"+curp_+"' and id_mes='7';"); 
              if (r2.next()){  mes2=true;  
               ...
               if(mes_ == 9){
              ResultSet r3= st2.executeQuery("SELECT * FROM calificaciones2 where curp='"+curp_+"' and id_mes='8';"); 
              ...
              ResultSet r4= st2.executeQuery("SELECT * FROM calificaciones2 where curp='"+curp_+"' and id_mes='9';"); 
              ...
              ResultSet r5= st2.executeQuery("SELECT * FROM calificaciones2 where curp='"+curp_+"' and id_mes='10';"); 
              ...
              ResultSet r6= st2.executeQuery("SELECT * FROM calificaciones2 where curp='"+curp_+"' and id_mes='1';"); 
              ...
              ResultSet r7= st2.executeQuery("SELECT * FROM calificaciones2 where curp='"+curp_+"' and id_mes='2';"); 
              ...
              ResultSet r8= st2.executeQuery("SELECT * FROM calificaciones2 where curp='"+curp_+"' and id_mes='3';"); 
            ...
            validar_mes();
              ...
              ResultSet r9= st2.executeQuery("SELECT * FROM calificaciones2 where curp='"+curp_+"' and id_mes='4';"); 
              ...
              ResultSet r10= st2.executeQuery("SELECT * FROM calificaciones2 where curp='"+curp_+"' and id_mes='5';"); 
    ...
    Mes mes = (Mes) cbx_mes.getSelectedItem(); //selecciona el dato que este en el combobox
        ...
        try {
            ...
            if(cal1<5 || cal1 >10){
              ...
              cali.registrarCalificacion2(1, id, curp_, grado_, cal1, cal2, cal3, cal4, cal5, cal6, mes_, periodo_);
