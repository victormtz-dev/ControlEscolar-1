 ...
 * @author victormanuel
 */
public class Estadisticas_inasistencias extends javax.swing.JInternalFrame {
     ...
     */
    public Estadisticas_inasistencias() {
        initComponents();
       ...
       // btn_registrar.setEnabled(false); //boton inhabilitado
        ...
        DefaultComboBoxModel CB_per = new DefaultComboBoxModel(per.mostrarPeriodo()); // va a la clase periodo y me trae los datos para llenar el combobox
        cbx_periodo.setModel(CB_per);
 ...
 public void validadcaracterescurp (java.awt.event.KeyEvent evento){
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(cbx_periodo, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        ...
        Periodo p = (Periodo) cbx_periodo.getSelectedItem(); //selecciona el dato que este en el combobox
        ...
        try {
           ...
           //se busca la ruta en donde se encuentra el reporte para enviarle los datos
            ...
            String path = "src\\Estadisticas\\inasistencias.jasper";
            ...
            parametro.put("periodo_entrada", p_);
            
            //reporte = (JasperReport) JRLoader.loadObjectFromFile(path);
            reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Estadisticas/inasistencias.jasper"));
            ...
            Logger.getLogger(Estadisticas_inasistencias.class.getName()).log(Level.SEVERE, null, ex);
        }              
