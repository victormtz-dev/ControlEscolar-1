...
public class Alumno_consulta {
    ...
    public void modificarAlumno(int operador, int id, String ap, String am, String nom, String sexo, String curp, String tutor, String correo, int grado, int grupo, String eliminar, int edad, String curpvieja) {
    ...
    public int existeAlumno(String curp) {
        ...
        try {
            ...
            ps = (PreparedStatement) con.getConnection().prepareStatement(ls_accion); //Ejecuta la operacion SQL, según selección "ls_accion"
            ps.setString(1, curp);
            rs = ps.executeQuery();
...
//			System.out.println(e.getMessage());
    ...
    public void BuscarAlumno(DefaultTableModel modelo, String ap) {
        ...
        try {
            ...
            //genera un query o consulta de la tabla especificada
            //Y regresa el resultado de la consulta en un objeto ResultSet
            ResultSet rs = estatuto.executeQuery("SELECT a.curp, a.apellido_paterno, a.apellido_materno, a.nombre, a.sexo, a.edad, a.id_grado , gp.letra "
